...
def bus_hists():
    ...
    # School: [Drop_off, Start_Time, End_Time, Color]
    school_time = {"ALT": ["09:20", "09:30", "00:00"],
                   "BAR": ["08:50", "09:05", "15:05"],
                   "BRO": ["09:00", "09:15", "15:15"],
                   "CAM": ["07:55", "08:15", "14:25"],
                   "CHA": ["08:00", "08:30", "15:30"],
                   "DUN": ["08:50", "09:05", "15:05"],
                   "FHS": ["07:00", "07:25", "13:55"],
                   "FUL": ["07:55", "08:15", "14:25"],
                   "HEM": ["09:00", "09:15", "15:15"],
                   "JUN": ["00:00", "00:00", "00:00"],  # NEEDS VERIFICATION
                   "KNG": ["09:10", "09:25", "15:25"],
                   "MAR": ["07:18", "07:20", "13:45"],
                   "MCC": ["08:00", "08:15", "14:15"],
                   "POT": ["09:00", "09:15", "15:15"],
                   "STA": ["08:50", "09:05", "15:05"],
                   "STB": ["00:00", "00:00", "00:00"],  # NEEDS VERIFICATION
                   "WAL": ["07:55", "08:15", "14:25"],
                   "WIL": ["08:50", "09:05", "15:05"]
                   }
    ...
    for index, row in df.iterrows():
        bus_id = row['dropoff_bus']
        if type(row['dropoff_time']) != str:
            continue
    ...
    for key in bus_dict:
        ...
        starts = [datetime.strptime(school_time[x][2], '%H:%M') for x in schools]
        print(schools)
